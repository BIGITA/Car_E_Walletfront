           ...
           <div className="container">
             <div className='row justify-content-center'>
                <div className="col-md-8 mt-5">
                   ...
                   <p className="lead text-center fs-4 mb-5 text-white">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Officiis iure ut sapiente architecto maiores pariatur cumque qui voluptatum repudiandae soluta ipsam, asperiores facilis ab ratione ducimus! Animi, nulla. Deserunt, minus?</p>
