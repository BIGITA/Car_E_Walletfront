...
const Navbar =()=>{
  ...
  <div className="container">
    ...
    <div className="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <NavLink className="navbar-brand fw-bolder fs-4 mx-auto" to="/">Car E Wallet</NavLink>
      ...
      <NavLink to='/logout' className="btn btn-outline-primary ms-2 px-4 rounded-pill"><i className="fa fa-sign-out me-2"></i>Logout</NavLink>  
